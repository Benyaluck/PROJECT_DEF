...
{
     Monster2 red = new Monster2();
     Monster1 pink = new Monster1();
     Monster4 blue = new Monster4();
     Monster3 orange = new Monster3();
     ...
     Mushroom bigBall1 = new Mushroom();
     Mushroom bigBall2 = new Mushroom();
     Mushroom bigBall3 = new Mushroom();
     Mushroom bigBall4 = new Mushroom();
    ...
    
    {
       ...
       if(catcher.returnIntersectingBalls()!=null&&!gameOver)
       {
           ...
           gameWinCount++;
            getWorld().removeObject((Banana)(catcher.returnIntersectingBalls()));
            ballCount++;
            setScore(ballCount);
       }
       if(ballTimerStarted)
       ...
       if(catcher.returnIntersectingRedGhost()!=null&&powerUp&&!gameOver)
       {
           ...
           getWorld().removeObjects(getWorld().getObjectsAt(this.getX(),this.getY(),Monster2.class));
       ...
       {
           Greenfoot.playSound("pacman_eatghost.wav");
           getWorld().removeObjects(getWorld().getObjectsAt(this.getX(),this.getY(),Monster1.class));
       ...
       {
           Greenfoot.playSound("pacman_eatghost.wav");
           getWorld().removeObjects(getWorld().getObjectsAt(this.getX(),this.getY(),Monster4.class));
       ...
       {
           Greenfoot.playSound("pacman_eatghost.wav");
           getWorld().removeObjects(getWorld().getObjectsAt(this.getX(),this.getY(),Monster3.class));
       ...
       if(catcher.returnIntersectingBigBall()!=null&&!gameOver)
       {
           ghostTimer.stopTimer();
            getWorld().removeObjects(getWorld().getObjectsAt(this.getX(),this.getY(),Mushroom.class));
            powerUp=true;
            this.getRedGhost().setImage("monster2.png");
            this.getPinkGhost().setImage("monster1.png");
            this.getBlueGhost().setImage("monster4.png");
            this.getOrangeGhost().setImage("monster3.png");
       }
       if(powerUp)
       {
    ...
    public Mushroom getBigBall1()
    {
        return bigBall1;
    }
    public Mushroom getBigBall2()
    {
        return bigBall2;
    }
    public Mushroom getBigBall3()
    {
        return bigBall3;
    }
    public Mushroom getBigBall4()
    {
        return bigBall4;
    }
    public Monster2 getRedGhost()
    {
        return red;
    }
    public Monster1 getPinkGhost()
    {
        return pink;
    }
    public Monster4 getBlueGhost()
    {
        return blue;
    }
    public Monster3 getOrangeGhost()
    {
        return orange;
    }
